...
const menuMaker = (menuArray) =>{
  ...
  // const whtsNwLi = document.createElement('li'); 
  // const techTrndLi = document.createElement('li');
  ...
  let imgClass = document.querySelector('.menu-button')
...
newMenu.appendChild(menuMaker(menuItems))
